...
// Interface for the response from the user-details endpoint
...
export const useAuth = () => {
  const [authTokens, setAuthTokens] = useState<typeof authTokensStore>(authTokensStore);
  const email = authTokens?.idToken ? extractEmailFromToken(authTokens.idToken) : null;
